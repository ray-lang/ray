...
// impl CollectDeclarations for Node<HirDecl> {
//     type Output = Node<HirDecl>;
...
// impl CollectConstraints for Module<HirNode, HirDecl, SourceInfo> {
//     type Output = Module<HirNode, HirDecl, HirInfo>;
...
// impl CollectConstraints for Node<HirNode> {
//     type Output = Node<HirNode>;
